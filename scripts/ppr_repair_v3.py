...
PDB_PATH = os.environ.get("PPR_INPUT_PDB", "")
OUT_PATH = os.environ.get("PPR_OUT_PDB", os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "output_2013nt", "repaired_v3.pdb"))
